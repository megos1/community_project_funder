...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { project_item_id: @donation.project_item_id, quantity: @donation.quantity, user_id: @donation.user_id }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { project_item_id: @donation.project_item_id, quantity: @donation.quantity, user_id: @donation.user_id }
    assert_redirected_to donation_path(assigns(:donation))
  end
